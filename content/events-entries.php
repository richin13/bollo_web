...
<div id="loading-events" class="text-center hidden">
    <h2>Cargando <i class="fa fa-cog fa-spin"></i></h2>
</div>
<div id="no-entries" class="alert alert-info hidden" role="alert">Aún no se ha generado ningún evento.</div>
